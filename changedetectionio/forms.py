    ...
    def __call__(self, form, field):
        ...
        if field.data is not None:
            ...
            try:
                ...
                message += "<br/><br/>" + field.gettext(
                    "WebDriver Host: %s" % (driver_url)
                )
...
class commonSettingsForm(Form):
    ...
    notification_urls = StringListField(
        ...
        validators=[validators.Optional(), ValidateAppRiseServers()],
    )
...
class watchForm(commonSettingsForm):
    ...
    minutes_between_check = html5.IntegerField(
        "Maximum time in seconds until recheck.",
...
class globalSettingsForm(commonSettingsForm):
    ...
    extract_title_as_title = BooleanField(
        "Extract <title> from document and use as watch title"
    )
