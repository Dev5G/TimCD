    ...
    def __init__(
        ...
        # First time ran, doesnt exist.
            ...
            if include_default_watches:
                ...
                self.add_watch(
                    url="http://www.quotationspage.com/random.php", tag="test"
                )
    ...
    def data(self):
        ...
        for uuid, v in self.__data["watching"].items():
            ...
            if not self.__data["watching"][uuid]["fetch_backend"]:
                self.__data["watching"][uuid]["fetch_backend"] = self.__data[
                    "settings"
                ]["application"]["fetch_backend"]
        ...
        for timestamp in del_timestamps:
            ...
            if limit_timestamp:
                ...
                if newest_key:
                    ...
                    try:
                        with open(
                            self.data["watching"][uuid]["history"][str(newest_key)],
                            "rb",
                        ) as fp:
                            content = fp.read()
